...
public class ListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View ListView, ViewGroup parent) {
        ...
        if (ListView == null) {
            ListView = inflater.inflate(R.layout.childs, null);
        }

        TextView item = (TextView) ListView.findViewById(R.id.child);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View ListView, ViewGroup parent) {
        ...
        if (ListView == null) {
            ...
            ListView = infalInflater.inflate(R.layout.parents,null);
        }
        TextView item = (TextView) ListView.findViewById(R.id.parent);
